...
public class Seekbar extends DialogPreference implements OnSeekBarChangeListener{
	
	
private final String TAG = getClass().getName();
    
    private static final String ANDROIDNS="http://schemas.android.com/apk/res/android";
	 private static final String ROBOBUNNYNS="com.hrh.shaketorch";
		...
		TextView mValueText,mStatusText;
	 ...
	 @Override
	    ...
	    public void onBindView(View view) {
	        ...
	        try
	        {
	            ...
	            ViewGroup newContainer = (ViewGroup) view.findViewById(R.id.seekbar);
	    ...
	    protected void updateView(View view) {
	        ...
	        try {
	            ...
	            mStatusText = (TextView)layout.findViewById(R.id.current_value);
	            mStatusText.setText(String.valueOf(mCurrentValue));
	            mStatusText.setMinimumWidth(30);
	            
	            mSeekBar.setProgress(mCurrentValue - mMinValue);

	            TextView unitsRight = (TextView)layout.findViewById(R.id.min_value);
	            unitsRight.setText(mUnitsRight);
	            
	            TextView unitsLeft = (TextView)layout.findViewById(R.id.max_value);
