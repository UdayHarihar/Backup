...
public void fill() {
  ...
  //  MenuItem item = null;
    items[0].label="uday";
 //   items[0].icon=item.getItemId();
    items[1].label="ravi";
    items[1].icon=R.string._drawable_ic_launcher;
    items[2].label="girish";
    items[1].icon=R.string._drawable_ic_launcher;
    items[3].label="harish";
    items[3].icon=R.string._drawable_ic_launcher;
    items[4].label="chetan";
    items[4].icon=R.string._drawable_ic_launcher;
